...
def create_address(address: AddressRequest):
    ...
    try:
        ...
        logger.info(f"Address with ID {db_address.id} created successfully")
...
def get_addresses_within_distance(latitude: float, longitude: float, distance: float):
    ...
    try:
        ...
        addresses_dict = [address.__dict__ for address in addresses]
        logger.info(f"Found All Addresses: {addresses_dict}")
...
def delete_address(address_id: int):
    ...
    db.delete(address)
    db.commit()
    logger.info(f"Address Deleted Successfully of Address_Id {address_id}")
...
def update_address(address_id: int, address: AddressRequest):
    ...
    if db_address:
        ...
        db.commit()
        logger.info(f"Address Updated Successfully of Address_Id {address_id}")
